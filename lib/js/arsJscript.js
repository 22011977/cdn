    ...
    */	
	...
	Syntax:
	     if you want to fetch value of a parameter e.g "pageName" from url  http://anywebsite.com?pageName=example.com
		      
		        p=getParams();   //p have all key/value pairs after ? slpit on & = 
			pn = p["pageName"];   //extract value of pageName parameter from url
                                 now pn value is "example.com"
	*/   
